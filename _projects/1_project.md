...
Large language models are rapidly becoming part of everyday writing, research, education, and software development.  
As these systems become more powerful, it becomes increasingly important to understand when a piece of text was generated by an AI system, whether it has been modified, and what guarantees such detection mechanisms can provide.
...
Cryptography has repeatedly shown that informal security ideas can fail unless they are supported by precise definitions and proofs.  
LLM watermarking is no exception.
...
We show a separation result identifying limitations of certain approaches to watermarking LLM outputs.  
This helps clarify which kinds of cryptographic techniques are insufficient and where stronger ideas or assumptions are needed.

### CCA-secure watermarking

We also study watermarking in a stronger security model inspired by chosen-ciphertext security.  
This gives a more robust framework for understanding watermarking when an adversary can interact with detection or verification procedures in a powerful way.    </div>
